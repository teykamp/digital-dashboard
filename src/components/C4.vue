<template>
  <div style="margin-top: 250px;">
    ...
    <div style="position: relative; margin-top: -60px; left: 10px; top: -100px">
      <div v-for="index in computeSpeedIndexes" :style="{
          position: 'absolute',
    ...
    <div style="position: relative; margin-top: -60px; left: 500px; top: -100px">
      <div v-for="index in computeRpmIndexes" :style="{
          position: 'absolute',
          height: '270px',
    ...
    <div
      style="position: relative; display: flex; justify-content: space-between; width: 400px;  z-index: 99; left: 350px; scale: 0.7; top: -340px;"
    >
      <div
        v-for="index in 2" 
        style="background: black; padding: 10px; border-radius: 10px;"
      >
        <TurnSignal 
          :style="{
